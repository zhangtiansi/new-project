...
$this->title = '玩家时时乐日金币变更信息';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="coin-ssl-index">
...
//         'filterModel' => $searchModel,
        'columns' => [
            'gid', 'point','name', 'total_coin:integer', 'maxCoin:integer', 'totalwin:integer', 'totalbet:integer', 'totalchange:integer', 'winTime','ctime',           
//              [
//             'attribute'=>'regtime',
...
jQuery(function($) {
    ...
    $('.coinssl').addClass("active");
    $('.coinssl').parent('ul').parent('li').addClass("active open");
    $('.gift').click(function(){
