...
//         'filterModel' => $searchModel,
        'columns' => [
            'gid','name', 'point', 'total_coin:integer', 'maxCoin:integer', 'totalchange:integer', 'winTime', 'ctime',
//             [
//             'attribute'=>'regtime',
...
jQuery(function($) {
    ...
    $('.coingame').addClass("active");
    $('.coingame').parent('ul').parent('li').addClass("active open");
    $('.gift').click(function(){
