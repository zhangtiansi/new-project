					...
					<ul class="nav ace-nav">
						<li class="light-blue">
							...
							<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li>
									<?= Html::a('<i class="icon-off"></i>退出', '/channel/site/logout', ['data-method' => 'post'])?>
								</li>
							</ul>
						</li>
					</ul><!-- /.ace-nav -->
				...
				<div class="sidebar" id="sidebar"><!-- 左边侧边栏 -->
					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul class="submenu">
								<li class="data-user">
									<a href="/channel/channeluser">
										<i class="icon-double-angle-right"></i>
										<i class="icon-bar-chart"></i>每日用户数据
									</a>
								</li>
                                <?php $user = User::findIdentity(Yii::$app->user->id);
                                        if (is_object($user) && Yii::$app->user->identity->checkRole(User::ROLE_CHANNEL_CPS)):
                                ?>
                                  <li class="data-recharge">
									<a href="/channel/dailyrecharge">
										<i class="icon-double-angle-right"></i>
                                ...
                                <?php endif;?>
                                <?php $user = User::findIdentity(Yii::$app->user->id);
                                    if (is_object($user) &&(Yii::$app->user->id==149)):
                                ?>
                                  <li class="data-recharge">
									<a href="/channel/dailystay">
										<i class="icon-double-angle-right"></i>
										<i class="icon-bar-chart"></i>每日留存
									</a>
								</li>  
                                <?php endif;?>
							</ul>
