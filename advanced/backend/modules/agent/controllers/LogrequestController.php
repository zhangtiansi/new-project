...
/**
 * LogrequestController implements the CRUD actions for LogUserrequst model.
 */
class LogrequestController extends AdmController
{
    ...
    public function actionIndex()
    {
        ...
        if (Yii::$app->getRequest()->getQueryParam('gid',"")!=""
            ||Yii::$app->getRequest()->getQueryParam('ime',"")!=""
            ||Yii::$app->getRequest()->getQueryParam('ip',"")!=""
            )
        {
            $dataProvider = $searchModel->search([
                'LogUserrequstSearch'=>[
                    'gid'=>Yii::$app->getRequest()->getQueryParam('gid')
                    ,'dev_id'=>Yii::$app->getRequest()->getQueryParam('ime')
                    ,'request_ip'=>Yii::$app->getRequest()->getQueryParam('ip')
                ]]);
        }else{
