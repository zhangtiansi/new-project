					...
					<ul class="nav ace-nav">
						<li class="light-blue">
							...
							<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li>
									<?= Html::a('<i class="icon-off"></i>退出', '/agent/site/logout', ['data-method' => 'post'])?>
								</li>
							</ul>
						</li>
					</ul><!-- /.ace-nav -->
				...
				<div class="sidebar" id="sidebar"><!-- 左边侧边栏 -->
					...
					<ul class="nav nav-list">
						...
						<li >
							...
							<ul class="submenu">
							     <li class="cusrecharge">
									<a href="/agent/customer/recharge">
										<i class="icon-double-angle-right"></i>
										<i class="icon-group"></i>充值
									</a>
								</li>
								<li class="agent-gift">
									<a href="/agent/customer/gift">
										<i class="icon-double-angle-right"></i>
										<i class="icon-group"></i>赠送
									</a>
								</li>
								<li class="customerplayer">
									<a href="/agent/accountview">
										<i class="icon-double-angle-right"></i>
                                ...
                                <li class="customerplayer">
								 ...
								 <li class="loggfit">
									<a href="/agent/loggift">
										<i class="icon-double-angle-right"></i>
										<i class="icon-gift"></i>礼品日志
									</a>
								</li>
								<li class="sendmail">
									<a href="/agent/logmail/create">
										<i class="icon-double-angle-right"></i>
										<i class="icon-gift"></i>发文字邮件
									</a>
								</li> 
								<li class="log-request">
									<a href="/agent/logrequest">
										<i class="icon-double-angle-right"></i>
								...
								<li class="logcoin">
									<a href="/agent/logcoin?gid=1">
										<i class="icon-double-angle-right"></i>
										<i class="icon-list"></i>金币变更记录
									</a>
								</li>
								<li class="logcoinhis">
									<a href="/agent/logcoinhis?gid=1">
										<i class="icon-double-angle-right"></i>
						...
						<li>
							<a href="#" class="dropdown-toggle">
								<i class="icon-desktop"></i>
								<span class="menu-text">平台配置</span>
								<b class="arrow icon-angle-down"></b>
							</a>

							<ul class="submenu">
								<li class="opslogs">
									<a href="/agent/sysoplogs">
										<i class="icon-double-angle-right"></i>
										<i class="icon-fire"></i>我的操作日志
									</a>
								</li>
								<li class="ops-gift">
									<a href="/agent/customer/index">
										<i class="icon-double-angle-right"></i>
										<i class="icon-gift"></i>我的赠送/充值日志
									</a>
								</li>
							</ul>
						</li>
