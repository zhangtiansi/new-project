          ...
          <div class="box table-responsive">
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="pay_time" id="datepicker" placeholder="天数不重要" style="display:inline-block; width:auto; margin-left:8px;" value="<?php echo isset($pay_time) ? $pay_time : ''?>">
                </div>
            ...
            <?php foreach($list as $value):?>
                <tr>
                  ...
                  <td><?php echo $value->c_month?></td>
                  <td><?php echo $value->channel?></td>
                  <td><?php echo $value->pay_source?></td>
                  <td><?php echo $value->recharge?></td>
                  <td><?php echo $value->num?></td>
                  <td><?php echo $value->unum?></td>
                  <td><?php echo $value->arpu?></td>
                  <td><?php echo $value->pay_avg?></td>
