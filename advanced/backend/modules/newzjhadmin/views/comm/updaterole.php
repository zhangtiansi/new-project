                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5 formControls">
                            <input class="form-control" type="text" id="inputSales1" name="name" style="width: 304px;" placeholder="填写范围4-16个字符" datatype="*4-16" value="<?php echo $role->name?>"/>
...
<!--                    </div>-->
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" type="text" id="inputSales2" name="display_name" style="width: 304px;" value="<?php echo $role->display_name?>"/>
                            ...
                            <?php foreach($list as $value):?>
                                <div class="checkbox">
                                    <label style="color: rgb(159,159,159);font-size: 15px;font-weight:bold">
                                        <input type="checkbox" name="permission_id[]" value="<?php echo $value->id?>" <?php echo $permission_id !='' && in_array($value->id, $permission_id) ? 'checked' : ''?>>
