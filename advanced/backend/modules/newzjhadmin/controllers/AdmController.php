...
//                 'only'=>['index','error','create','update','view'],
                ...
                'rules' => [
                    ...
                    [
                        'allow' => true,
                        'actions' => [ 'index','create','sslconf','coin','banip','getdata','findout','gettopgift','topgift','send','mail','hischange','tbs','his','modssl4','sysconf','error','getsslper','getsslwin','view','update','datacenter','usersystem','recent','getserverid','getbet','getrecentdata','unreadlist','readlist','fetchunread','sendcust','mod','month','finduser','thequerypassword','permissionfind','deletepermission','channel','createchannel','createpermission','updatepermission','createuser','createroles','updaterole','rolesdelete','updateuser','userdelete'],
