						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								...
								<span class="user-info">
									<small>欢迎光临,</small>
									<?php //echo Yii::app()->user->isGuest?"Guest":OpUser::model()->getUserName(Yii::app()->user->name);?>
								</span>
							...
							<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li>
									<?= Html::a('<i class="icon-off"></i>退出', '/customer/site/logout', ['data-method' => 'post'])?>
								</li>
							</ul>
						</li>
					</ul><!-- /.ace-nav -->
						...
						<li >
							...
							<ul class="submenu">
								<li class="customer-msg">
									<a href="/customer/logmsg">
										<i class="icon-double-angle-right"></i>
										客服消息
									</a>
								</li>
                                <li class="customerplayer">
									<a href="/customer/player">
										<i class="icon-double-angle-right"></i>
										客户管理
									</a>
								</li>
