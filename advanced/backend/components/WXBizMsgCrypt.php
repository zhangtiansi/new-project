...
use yii;
use app\components\Prpcrypt;
use app\components\sha1;
use app\components\XMLParse;
...
class WXBizMsgCrypt
{
	...
	*/
	...
	{
	    Yii::error("verify url :".$sMsgSignature." time : ".$sTimeStamp." snonce :".$sNonce." secho str".$sEchoStr,'wxapi');
		...
		if ($signature != $sMsgSignature) {
		    Yii::error("check wxapi signature  ".$signature." sMsgSignature".$sMsgSignature,'wxapi');
