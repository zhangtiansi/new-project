 ...
 */
class LogCoinRecordsSearch extends LogCoinRecords
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'uid', 'from_uid', 'change_type', 'change_before', 'change_coin', 'change_after', 'prop_id'], 'integer'],
