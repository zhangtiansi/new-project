...
class CfgProducts extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['utime','coin','card_kick','card_laba','card_rename'], 'safe'],
    ...
    {
        // 产品和订单通过 GmOrderlist.productid -> product_id 关联建立一对多关系
        return $this->hasMany(GmOrderlist::className(), ['productid' => 'product_id']);
    }
    
    public static function getProductByid($id)
    {
        return CfgProducts::findOne($id)->product_id;
    }
    
    public static function getProductList()
    {
        $ar = CfgProducts::find()->all();
        return $ar;
    }
}
