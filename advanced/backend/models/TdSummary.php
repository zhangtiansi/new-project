 ...
 */
class TdSummary extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            [['cdate', 'utime'], 'safe'],
            [['reg_num', 'login_num', 'active_num', 'regact_num', 'recharge_total', 'recharge_num', 'agent_cash', 'max_online', 'now_online', 'ssl_bet', 'ssl_reward', 'ssl_pool','slot_coin'], 'integer'],
            [['cdate'], 'unique']
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'ssl_pool' => 'Ssl Pool',
            'hundred_coin'=>'hundred_coin',
            'hundred_num'=>'hundred_coin',
            'hundred_zhuang'=>'hundred_coin',
            'slot_coin'=>'水浒传coin',
        ];
    }
}
