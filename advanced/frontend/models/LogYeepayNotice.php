...
class LogYeepayNotice extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['ptype', 'orderid', 'gid', 'productid', 'r0_Cmd', 'r1_Code', 'p1_MerId', 'p2_Order', 'p3_Amt', 'p4_FrpId', 'p5_CardNo', 'p6_confirmAmount', 'p7_realAmount', 'p8_cardStatus', 'hmac'], 'required'],
            [['gid', 'r1_Code'], 'integer'],
            [['ptype', 'productid'], 'string', 'max' => 30],
            [['orderid'], 'string', 'max' => 60],
            [['r0_Cmd', 'p2_Order', 'r2_TrxId'], 'string', 'max' => 50],
            [['p1_MerId', 'p3_Amt'], 'string', 'max' => 20],
            [['p4_FrpId'], 'string', 'max' => 10],
