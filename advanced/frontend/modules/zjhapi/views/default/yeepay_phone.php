...
<div style="padding-top: 10px"><p style="font-size:18px">您将要购买产品：<span class="text-danger"><?= $product_name ?>，</span>金额：<span class="text-danger"><?= $price ?></span>元<br>
您选择了<span class="text-danger"><?= $source?></span>，需要充值面额<span class="text-danger"><?= $cardprice;?></span>元</p>
<br>
</div>
</div>
